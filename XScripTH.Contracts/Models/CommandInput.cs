...
public sealed class CommandInput(IReadOnlyList<object?>? values = null, IExecutionContext? executionContext = null) : ICommandIo
{
    ...
    public static CommandInput FromValues(IExecutionContext executionContext, params object?[] values) => new(values, executionContext);
}
