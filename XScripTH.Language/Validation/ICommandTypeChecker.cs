...
{
    Task<CommandTypeCheckResult> ValidateAsync(IEnumerable<ICommandInvocation> invocations,
        CancellationToken cancellationToken = default);

    Task<CommandTypeCheckResult> ValidateInvocationAsync(ICommandInvocation invocation,
        CancellationToken cancellationToken = default);
